...
def savedDisplayView(request,username):
    if(request.user.username != username): 
        return HttpResponseNotFound("<b>Sorry, this page isn't available.</b> The link you followed may be broken, or the page may have been removed. <a href='/'>Go back to JameaGram.</a>")    
